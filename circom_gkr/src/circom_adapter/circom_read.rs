...
/// CIRCOM READ
///
/// This file contains the logic used to read a circom program
/// and convert it to a set of constraints
//////////////////////////////////////////////////////////////////
use super::{
...
mod test {
    ...
    fn test_read_circom_constraint() {
        let constraints =
            ...
            assert!(constraints.total_constraint == 4, "Incomplete constraints");
    }
}
